...
class Ui_JarvisUI(object):
    ...
    def setupUi(self, JarvisUI):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(rf"{self.cpath}\UI\login.png"))
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 360, 600, 400))
        self.label_5.setText("")
        # self.label_5.setPixmap(QtGui.QPixmap(rf"{self.cpath}\UI\jarvis.gif"))
