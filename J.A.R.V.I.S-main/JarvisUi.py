...
class Ui_JarvisUI(object):
    ...
    def setupUi(self, JarvisUI):
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(300, 860, 200, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(500, 860, 180, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, JarvisUI):
        ...
        self.pushButton_6.setText(_translate("JarvisUI","FRENCH"))
        self.pushButton_5.setText(_translate("JarviaUI","ENGLISH"))
